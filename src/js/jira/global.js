const globalJIRA = {
    ...
    init() {
        ...
        newItem += '<li><a href="/issues/?jql=labels%20%3D%20css-automated-nodue">Labels - No Due Date</a></li>';
        newItem += '<li><a href="/issues/?jql=labels%20%3D%20css-automated-noquote">Labels - No Quote</a></li>';
        newItem += '</div>';
        newItem += '<div class="aui-dropdown2-section">';        
        newItem += '</ul>';
        newItem += '<ul id="report" class="aui-list-truncate">';
